...
public class PathOutputCommitterWork implements Serializable {
    ...
    private Set<String> writerIds = new HashSet<>();
    ...
    public Set<String> writeIds() {
        return Collections.unmodifiableSet(writerIds);
    }
    ...
    public String getPathOutputCommitterFactoryClass() {
        return getPathOutputCommitterClass().getName();
    }
